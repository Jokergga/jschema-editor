...
const SchemaItem = observer(
  (props: SchemaItemProp): ReactElement => {
    const { data, name, prefix, showAdv, showEdit } = props;

    // noinspection DuplicatedCode
    const [tagPaddingLeftStyle, setTagPaddingLeftStyle] = useState<
      CSSProperties
    >({});
  ...
  */
    ...
    return _.get(mobxContext.open, prefix.join(JSONPATH_JOIN_CHAR)) ? (
      <div>
        <Row justify="space-around" gutter={11} align="middle" wrap={false}>
          <Col flex="auto">
            <Row justify="space-around" gutter={11} align="middle" wrap={false}>
              <Col span={8} style={tagPaddingLeftStyle}>
                ...
                >
                  ...
                  <Col flex="auto">
                    <FieldInput
                      addonAfter={
                        <Tooltip placement="top" title="必需">
                          <Checkbox
                            style={{ paddingLeft: 0 }}
                            onChange={event =>
          ...
          <Col flex="66px">
            <Row gutter={8}>
              <Col span={8}>
                <span
                  className="plus"
                  onClick={value.type === 'object' ? () => {} : handleAddField}
                >
                  {value.type === 'object' ? (
              ...
              <Col span={8}>
                <span className="close" onClick={handleDeleteItem}>
                  {/* <CloseOutlined /> */}
                  <IconFont toolTit="删除" type="icon-del" />
                </span>
              </Col>
            </Row>
          </Col>
